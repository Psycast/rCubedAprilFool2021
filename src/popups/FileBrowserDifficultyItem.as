package popups
{
    ...
    import menu.DifficultyItem;

    public class FileBrowserDifficultyItem extends DifficultyItem
    {
        public var cache_info:Object;

        public function FileBrowserDifficultyItem(index:int, cache_info:Object):void
        {
        ...
        {
            addChild(new AFChartDifficultyLargeItem());
