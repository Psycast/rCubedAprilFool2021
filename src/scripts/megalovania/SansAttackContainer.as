package scripts.megalovania
{
    ...
    public class SansAttackContainer extends Sprite
    {
        ...
        public var ItemDB:Array = [[0, 99, "Butterscotch Pie", "Pie"],
        ...
        public function PlaySound(sound:String, rate:Number = 1, tag:String = ""):void
        { // Real Method: Sound
            // Music Handler
            if (sound == "Music")
            {
        ...
        public function StartAttack():void
        {
            ...
            if (HitAttempts < 13)
            {
                if (NextAttack == 0)
                {
                    RunAttack("sans_intro");
                    NextAttack++;
                }
                else if (NextAttack == 1)
                {
                    RunAttack("sans_bonegap1");
                    NextAttack++;
                }
                else if (NextAttack == 2)
                {
                    RunAttack("sans_bluebone");
                    NextAttack++;
                }
                else if (NextAttack == 3)
                {
                    RunAttack("sans_bonegap2");
                    NextAttack++;
                }
                else if (NextAttack == 4)
                {
                    RunAttack("sans_platforms1");
                    NextAttack++;
                }
                else if (NextAttack == 5)
                {
                    RunAttack("sans_platforms2");
                    NextAttack++;
                }
                else if (NextAttack == 6)
                {
                    RunAttack("sans_platforms3");
                    NextAttack++;
                }
                else if (NextAttack == 7)
                {
                    RunAttack("sans_platforms4");
                    NextAttack++;
                }
                else if (NextAttack == 8)
                {
                    RunAttack("sans_platformblaster");
                    NextAttack++;
                }
                else if (NextAttack == 9)
                {
                    RunAttack("sans_platforms4hard");
                    NextAttack++;
                }
                else if (NextAttack == 10)
                {
                    RunAttack("sans_bonegap1fast");
                    NextAttack++;
                }
                else if (NextAttack == 11)
                {
                    RunAttack("sans_boneslideh");
                    NextAttack++;
                }
                else if (NextAttack == 12)
                {
                    RunAttack("sans_bonegap2");
                    NextAttack++;
                }
                else if (NextAttack == 13)
                {
                    RunAttack("sans_platformblasterfast");
                    NextAttack++;
                }
                else if (NextAttack == 14)
                {
                    RunAttack(ArrayUtil.randomize(["sans_bonegap1fast", "sans_bonegap2", "sans_boneslideh", "sans_platformblasterfast"])[0]);
                }
            }
            ...
            else if (HitAttempts > 13 && HitAttempts <= 22)
            {
                if (NextAttack == 0)
                {
                    RunAttack("sans_multi1");
                    NextAttack++;
                }
                else if (NextAttack == 1)
                {
                    RunAttack("sans_randomblaster1");
                    NextAttack++;
                }
                else if (NextAttack == 2)
                {
                    RunAttack("sans_multi2");
                    NextAttack++;
                }
                else if (NextAttack == 3)
                {
                    RunAttack("sans_bonestab1");
                    NextAttack++;
                }
                else if (NextAttack == 4)
                {
                    RunAttack("sans_bonestab2");
                    NextAttack++;
                }
                else if (NextAttack == 5)
                {
                    RunAttack("sans_randomblaster2");
                    NextAttack++;
                }
                else if (NextAttack == 6)
                {
                    RunAttack("sans_boneslidev");
                    NextAttack++;
                }
                else if (NextAttack == 7)
                {
                    RunAttack("sans_multi3");
                    NextAttack++;
                }
                else if (NextAttack == 8)
                {
                    RunAttack("sans_bonestab3");
                    NextAttack++;
                }
                else if (NextAttack == 9)
                {
                    RunAttack(ArrayUtil.randomize(["sans_bonestab3", "sans_multi3", "sans_randomblaster2"])[0]);
                }
            }
        ...
        public function EndAttack():void
        {
            ...
            if (HitAttempts == 13)
                combat_zone.InfoText = "* Sans is taking a break.";
            if (HitAttempts == 15)
                combat_zone.InfoText = "* The REAL battle finally begins.";
            if (HitAttempts == 19)
                combat_zone.InfoText = "* Reading this doesn't seem \n  like the best use of time.";
            if (HitAttempts == 20)
                combat_zone.InfoText = "* Sans is starting to look\n  really tired.";
            if (HitAttempts == 21)
                combat_zone.InfoText = "* Sans is preparing something.";
            if (HitAttempts == 22)
                combat_zone.InfoText = "* Sans is pregetting ready to\n  use his special attack.";
        ...
        {
            SansText("but i have\nnothing for you", "Win4");
        }

        public function Win4():void
        {
            SansText("that was a previous\nyears event", "Win5");
        }

        public function Win5():void
        {
        ...
        public function BattleMenuUpdate(delta:Number, eclipsed:Number):void
        {
            ...
            if (MenuTarget != null)
            {
                if (MenuTarget.State == 0)
                {
                    ...
                    if ((MenuTargetChoice.Direction == 0 && MenuTargetChoice.x > combat_zone.TargetRight) || (MenuTargetChoice.Direction == 2 && MenuTargetChoice.x < combat_zone.TargetLeft))
                    {
        ...
        public function PlayerDamageUpdate(delta:Number, eclipsed:Number):void
        {
            ...
            if (LastDamageTime < getTimer() - 33)
            {
                    ...
                    if (tickable is ISansDamageable)
                    {
                        ...
                        else if (iDamage.getHitbox().hitTestObject(player_heart.hitbox))
                        {
                            if (iDamage.getColor() == 1) // Blue, damage if moving.
                            {
                                ...
                                {
                                    //debugDrawDamagableCalc(iDamage, HGP);
                                    DamagePlayerTickable(iDamage);
                                    break tickLoop;
                                }
                            }
                ...
                if (menuBoneL != null && player_heart.visible)
                {
                    ...
                    {
                        //debugDrawDamagableCalc(menuBoneL, HGP);
                ...
                if (menuBoneB.length > 0 && player_heart.visible)
                {
                    for each (var boneBottom:SansMenuBoneBottom in menuBoneB)
                    {
                        ...
                        {
                            //debugDrawDamagableCalc(boneBottom, HGP);
                ...
                // Decay Health + Karma
                if (player_heart.KR > 40)
                    player_heart.KR = 40;
                if (player_heart.KR >= player_heart.HP)
                    player_heart.KR = player_heart.HP - 1;
        ...
        public function HPBarUpdate(delta:Number, eclipsed:Number):void
        {
            ...
            if (player_heart.KR == 0)
                HPText.transform.colorTransform.greenMultiplier = 1;
            if (player_heart.KR > 0)
                HPText.transform.colorTransform.greenMultiplier = 0;
        }
