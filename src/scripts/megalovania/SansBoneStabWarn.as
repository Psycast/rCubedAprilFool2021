        ...
        public function update(delta:Number, eclipsed:Number, script:SansBattleScript):void
        {
            ...
            else if (WarnTime <= 0 && Bones)
            {
                ...
                else
                {
                    ...
                    if (Direction == 0 && Bones.x < Bones.DestX)
                        Bones.x = Bones.DestX;
                    if (Direction == 1 && Bones.y < Bones.DestY)
                        Bones.y = Bones.DestY;
                    if (Direction == 2 && Bones.x > Bones.DestX)
                        Bones.x = Bones.DestX;
                    if (Direction == 3 && Bones.y > Bones.DestY)
                        Bones.y = Bones.DestY;
            ...
            if (Bones)
            {
                ...
                if (Bones.x > SansAttackContainer.CONTAINER_WIDTH)
                    isRemoved = true;
                if (Bones.y > SansAttackContainer.CONTAINER_HEIGHT)
                    isRemoved = true;
                if (Bones.x < -Bones.width)
                    isRemoved = true;
                if (Bones.y < -Bones.height)
                    isRemoved = true;
